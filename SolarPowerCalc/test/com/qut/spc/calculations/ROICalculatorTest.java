...
public class ROICalculatorTest {
	...
	public void test_ROICalculatorParameters() {
		ROICalulator = new ROICalculator(5, 0.23, 0.44, 10, 1000, 365);
	}
	@Test
	public void test_ROICalculatorParameters_electricity_zero() {
		ROICalulator = new ROICalculator(0, 0.23, 0.44, 10, 1000, 365);
	}
	...
	public void test_ROICalculatorParameters_feedInTariff_zero() {
		ROICalulator = new ROICalculator(5, 0, 0.44, 10, 1000, 365);
	}
	@Test(expected = IllegalArgumentException.class)
	...
	public void test_ROICalculatorParameters_costOfElectricity_zero() {
		ROICalulator = new ROICalculator(5, 0.23, 0, 10, 1000, 365);
	}
	@Test(expected = IllegalArgumentException.class)
	...
	public void test_ROICalculatorParameters_dailyUsage_zero() {
		ROICalulator = new ROICalculator(5, 0.23, 0.44, 0, 1000, 365);
	}
	@Test(expected = IllegalArgumentException.class)
	...
	public void test_ROICalculatorParameters_systemCost_zero() {
		ROICalulator = new ROICalculator(5, 0.23, 0.44, 10, 0, 365);
	}
	@Test(expected = IllegalArgumentException.class)
	...
	@Test
	public void test_ROICalculatorParameters_timeSpan_zero() {
		ROICalulator = new ROICalculator(5, 0.23, 0.44, 10, 1000, 0);
	}
	@Test(expected = IllegalArgumentException.class)
	public void test_ROICalculatorParameters_timeSpan_negative() {
		ROICalulator = new ROICalculator(5, 0.23, 0.44, 10, 1000, -365);
	}
	@Test
	public void test_ROICalculatorParameters_timeSpan_positive() {
		ROICalulator = new ROICalculator(5, 0.23, 0.44, 10, 1000, 365);
	}
	...
	public void test_SetAnnualElectricityProduction_zero() {
		ROICal.setDailyElectricityProduction(0);
	}
	@Test(expected = IllegalArgumentException.class)
	public void test_SetAnnualElectricityProduction_negative() {
		ROICal.setDailyElectricityProduction(-100);
	}
	@Test
	 ...
	 */
	@Test
	public void test_SetTimeSpan_zero() {
		ROICal.setTimeSpan(0);
	}
	@Test(expected = IllegalArgumentException.class)
	public void test_SetTimeSpan_negative() {
		ROICal.setTimeSpan(-365);
	}
	@Test
	public void test_SetTimeSpan_positive() {
		ROICal.setTimeSpan(365);
	}
	 ...
	 */
	@Test
	public void test_GetROI() {
		ROICalulator = new ROICalculator(5, 0.23, 0.44, 10, 10000,365);
		//System.out.println (ROICalulator.getROI());

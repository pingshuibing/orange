...
public class ElectricityCalculatorTest {
	...
	public void restrictInput_negativeDimension () {
		ElectricityCalculator calculator = new ElectricityCalculator();
		calculator.getElectricityProduction(-10.0,10.0,0.8,0.7,100.0,4.0,1.0);
	}
	
	@Test
	public void getElectricityProduction_sunPowerOver () {
		double electricity = calculator.getElectricityProduction(10.0,10.0,0.8,0.7,120.0,4.0,1.0);
	...
	public void getElectricityProduction_solarPanelOver () {
		double electricity = calculator.getElectricityProduction(10.0,12.0,0.8,0.7,100.0,4.0,1.0);
		assertEquals(215.04,electricity,0.01);
	}
	
	@Test
	public void getElectricityProduction_solarSunPowerEqual () {
		double electricity = calculator.getElectricityProduction(10.0,10.0,0.8,0.7,100.0,4.0,1.0);
		assertEquals(179.20,electricity,0.01);
	}
	...
	public void restrictInput_zeroDailySun () {
		ElectricityCalculator calculator = new ElectricityCalculator();
		assertEquals(0.0, calculator.getElectricityProduction(10.0,0.0,0.8,0.7,100.0,4.0,1.0), 0.01);
	}
	...
	public void restrictInput_overOneinverterEfficiency () {
		ElectricityCalculator calculator = new ElectricityCalculator();
		calculator.getElectricityProduction(10.0,10.0,1.2,0.7,100.0,4.0,1.0);
	}
	
	@Test
	public void restrictInput_oneinverterEfficiency () {
		ElectricityCalculator calculator = new ElectricityCalculator();
		assertEquals(224.0, calculator.getElectricityProduction(10.0,10.0,1,0.7,100.0,4.0,1.0), 0.01);
	}
	
	@Test
	public void restrictInput_zeroinverterEfficiency () {
		ElectricityCalculator calculator = new ElectricityCalculator();
		assertEquals(0.0, calculator.getElectricityProduction(10.0,10.0,0.0,0.7,100.0,4.0,1.0), 0.01);
	}
	...
	public void restrictInput_overOneSolarPanelEfficiency () {
		ElectricityCalculator calculator = new ElectricityCalculator();
		calculator.getElectricityProduction(10.0,10.0,0.8,1.2,100.0,4.0,1.0);
	}
	
	@Test
	public void restrictInput_oneSolarPanelEfficiency () {
		ElectricityCalculator calculator = new ElectricityCalculator();
		assertEquals(256.0, calculator.getElectricityProduction(10.0,10.0,0.8,1.0,100.0,4.0,1.0),0.01);
	}
	
	@Test
	public void restrictInput_zeroSolarPanelEfficiency () {
		ElectricityCalculator calculator = new ElectricityCalculator();
		assertEquals(0.0, calculator.getElectricityProduction(10.0,10.0,0.8,0.0,100.0,4.0,1.0),0.01);
	}
	...
	public void restrictInput_zeroSolarPowerOutput () {
		ElectricityCalculator calculator = new ElectricityCalculator();
		assertEquals(0.0, calculator.getElectricityProduction(10.0,10.0,0.8,0.7,0.0,4.0,1.0),0.01);
	}
	...
	public void restrictInput_zeroDailyHours () {
		ElectricityCalculator calculator = new ElectricityCalculator();
		assertEquals(0.0, calculator.getElectricityProduction(10.0,10.0,0.8,0.7,0.0,0.0,1.0),0.01);
	}
	...
	public void restrictInput_zeroTimespan () {
		ElectricityCalculator calculator = new ElectricityCalculator();
		assertEquals(0.0, calculator.getElectricityProduction(10.0,10.0,0.8,0.7,0.0,0.0,0.0),0.01);
	}
